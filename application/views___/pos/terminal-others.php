                        ...
                        <div class="row" id="stock_list">
                            ...
                            if(count($items) > 0){
                                foreach($items as $item){
                                    ?>
                                    <div data-qty="<?php echo $item['quantity'] ?>" data-track="<?php echo $item['track'] ?>"  data-amount="<?php echo $item['price'] ?>" data-id="<?php echo $item['SN']; ?>" data-item-name="<?php echo $item['product_name']  ?>" onclick="getInputFromBarcode('<?php echo $item['SN']; ?>',1)" class="col-lg-3 col-md-3 col-xs-6 shop-items filter-add-product noselect text-center" style="padding:5px; border-right: solid 1px #DEDEDE;border-top: solid 1px #DEDEDE;border-bottom: solid 1px #DEDEDE;height: 200px" data-design="velvet v-neck body suit">
                                        <img  class="img-responsive img-rounded lazy" src="<?php  echo empty($item['image']) ? $placeholder : base_url('product_image/'.$item['image']) ?>" width="100">
                                        <div class="caption text-center" style="padding:2px;overflow:hidden;"><strong class="item-grid-title"><span class="marquee_me"><?php echo $item['product_name'] ?></span></strong><br><span class="align-center">&#8358;<?php echo number_format($item['price'],2) ?></span></div>
                                    </div>
                                    <?php
                                }
                            }else{
...
<div class="btn-group btn-group-justified" role="group" aria-label="...">
			<div class="btn-group ng-scope" role="group" ng-controller="payBox">
			 <button id="pnow" type="button" class="btn btn-primary btn-lg sendToKitchenButton" onclick="PayNow()" style="margin-bottom:0px;"> <i class="fa fa-money"></i>
