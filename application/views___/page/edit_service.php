                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <select name="service_type" required class="form-control input-sm">
                                    <option <?php echo $service['service_type']== "Normal Service" ? 'selected' : '' ?> value="Normal Service">Normal Service</option>
                                    <option <?php echo $service['service_type']== "Hourly Service" ? 'selected' : '' ?> value="Hourly Service">Hourly Service</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    if(empty($service['image'])) {
                                        ...
                                        ?>
                                        <br/><br/>
                                        <img src="<?php echo base_url('product_image/'.$service['image']) ?>" style="width:60%"/>
                                        <?php
                                    }
                                    ?>
                                </div>
