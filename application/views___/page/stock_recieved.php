...
<div class="col-sm-12">
	 ...
	 <div class="panel panel-default panel-table">
                <div class="panel-heading">Daily Stock Received List(s)
                 <div class="tools">
				 	<div class="btn-group btn-space">
                        ...
                        <ul role="menu" class="dropdown-menu">
						 ...
						 if($this->stock->getUserDepartment() == "Administrator"){
							 $dept = $this->db->get_where("department",array("type"=>"Sales"))->result_array();
							 foreach($dept as $de){
						 ?>
						  <li><a href="<?php echo base_url('dashboard/choose_dept_new_recieved_supplier/'.$de['department'])  ?>">From Supplier For <?php echo $de['department']; ?></a></li>
						 <?php
							 }
						 }else{
						 ?>
				...
				<div class="panel-body">
				 <table id="table3" class="table table-striped table-hover table-fw-widget">
					...
					<?php
						...
						$recievers = $this->stock->getStockrecievedBetween(date('Y-m-d'),date('Y-m-d'));
