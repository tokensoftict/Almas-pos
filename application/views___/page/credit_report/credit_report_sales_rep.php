...
$stocks = array(array('id'=>$this->users->get_user_by_username($this->session->userdata("username"))->id));
?>
<input type="hidden" name="customer_id" id="customer_id" value="<?php echo $this->users->get_user_by_username($this->session->userdata("username"))->id; ?>" />	
<?php
}
?>	
						<?php
