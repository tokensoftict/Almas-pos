...
<div class="col-sm-12">
				...
				<div class="panel panel-default">
					...
					<div class="tools">
						 ...
						 <a target="_blank" href="<?php echo base_url('dashboard/print_transfer/'.$this->uri->segment(3))  ?>" class="btn btn-sm btn-primary"><i class="mdi mdi-edit"></i> Print Transfer</a>
