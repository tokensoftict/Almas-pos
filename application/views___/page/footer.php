...
if($this->users->get_user_by_username($this->session->userdata("username"))->role!="Sales Representative"  && $this->users->get_user_by_username($this->session->userdata("username"))->role!="Service Administrator"){
 ?>	
	...
	<?php
	}elseif($page=="credit_report/credit_reports" || $page=="view_received" || $page=="view_invoice" || $page=="credit_report/credit_report_payment_method" || $page=="credit_report/credit_report_sales_rep" || $page=="credit_report/credit_report_customer" || $page=="credit_report/credit_reports" || $page=="invoice_report/invoice_report_payment_method" || $page=="invoice_report/invoice_report_sales_rep" || $page=="invoice_report/invoice_report_customer" || $page=="invoice_report/invoice_reports" || $page=="stock" || $page=="stock_branch" || $page=="stockby_department" || $page=="list_service" || $page=="settings" || $page=="view_stock_list" || $page=="stock_transfer" || $page=="customerlist" || $page=="credits" || $page=="sales" || $page=="invoices" || $page=="view_transfer" || $page=="rma" || $page=="stock_recieved" || $page=="recieved_stock_report"|| $page=="stock_pick_up_report" || $page=="transfer_stock_report" || $page=="sales_report" || $page=="sales_reports" || $page=="report_customer"|| $page=="report_sales_rep" || $page=="report_stock" || $page=="invoice_report" || $page=="report_payment_method" || $page=="deposit_reports" || $page=="deposit_report_customer" || $page=="deposit_report_sales_rep" || $page=="deposit_report_payment_method"
	|| $page=="view_stock_movement" || $page=="expenses"   || $page=="staff_salary"  || $page=="new_salary_payment"  || $page=="view_history_salary" || $page=="profit_loss_general" || $page=="total_income_report" || $page=="by_report_customer" || $page=="by_report_sales_rep" || $page=="by_report_stock" || $page=="by_report_payment_method" || $page=="stock_expiry"  || $page=="expenses_monthly_report" || $page=="report_payment_method" || $page=="refund_report" || $page=="deposit_credit_report"  || $page=="assets_list"   || $page=="credit_payment_report"   || $page=="admin_refund_report" || $page=="stock_open_close"  || $page=="supplier_invoice_report"   || $page=="due_payment_report"   || $page=="out_of_stock"  || $page=="cash_ledger" || $page=="pos_payment"  || $page=="payment_method_sales_report" || $page=="vat_report"  || $page=="recieved_stock_report_byproduct" || $page=="sales_product" || $page=="daily_stock_balance"
	){
	?>
