				  ...
				  <div class="tab-content">
					...
					<div class="row">
						...
						<form action=""  method="post" enctype="multipart/form-data">
							...
							<div class="form-group xs-pt-10">
							<br/><br/><br/><br/><br/>
							  <label for="note" class="col-sm-12 control-label">Footer Receipt Notes Sales</label>
							  <div class="col-sm-12">
							  <textarea class="form-control" name="footer_rec" placeholder="Footer Receipt Notes"><?php echo $extra_charges['footer_rec'] ?></textarea>
							  </div>
							</div>
                            <div class="form-group xs-pt-10">
                                <br/><br/><br/><br/><br/>
                                <label for="note" class="col-sm-12 control-label">Footer Receipt Notes Service</label>
                                <div class="col-sm-12">
                                    <textarea class="form-control" name="footer_rec_service" placeholder="Footer Receipt Notes"><?php echo $extra_charges['footer_rec_service'] ?></textarea>
                                </div>
                            </div>
							<div class="form-group xs-pt-10">
							<br/><br/><br/><br/>
