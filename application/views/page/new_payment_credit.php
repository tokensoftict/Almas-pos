			  ...
			  <div class="panel-body">
				<div class="form-horizontal">
					...
					<div class="form-group xs-mt-10">
                      ...
                      <div class="col-sm-8">
                          <?php
                          $b = ($deposits['total_amount_paid'] -$this->stock->getTotalAmountCreditPaid($deposits['SN'],false));
                          ?>
                          <span id="price" min="1" disabled  type="number" required name="amount"  class="form-control input-sm"><?php echo number_format($b,2)  ?></span>
                      </div>
                    </div>
                    <div class="form-group xs-mt-10">
                        <label for="price" class="col-sm-2 control-label">Amount Paid</label>
                        <div class="col-sm-8">
                            <input id="price" min="1" max="<?php echo ($deposits['total_amount_paid'] -$this->stock->getTotalAmountCreditPaid($deposits['SN'],false)) ?>" value="" type="number" required name="amount"  placeholder="Amount Deposited" class="form-control input-sm">
                        </div>
                    </div>
