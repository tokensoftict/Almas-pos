                    ...
                    <ul class="sidebar-elements">
                        ...
                        <li class="parent"><a href="#"><span class="icon mdi mdi-face"></span>Customer Manager</a>
                            <ul class="sub-menu">
                                ...
                                <li> <a href="<?php echo base_url('dashboard/customersalesreport'); ?>">Customers Sales report</a></li>
                                <li> <a href="<?php echo base_url('dashboard/customercreditlog'); ?>">Customers Credit Log</a></li>
                                <li> <a href="<?php echo base_url('dashboard/customersalesreportbreakdown'); ?>">Customers Sales By Product</a></li>
                            </ul>
                        </li>
                        <li class="parent"><a href="#"><span class="icon mdi mdi-chart"></span>Sales Report</a>
                            <ul class="sub-menu">
                                ...
                                <li> <a href="<?php echo base_url('dashboard/vat_report'); ?>">VAT Report</a></li>
                            </ul>
                        </li>
