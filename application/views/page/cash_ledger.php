<div class="row">
	<div class="col-sm-12">
		...
		<div class="panel panel-default">
                <div class="panel-heading">My Cash Transaction List</div>
				...
				<tbody>
					...
					<?php
						...
						$id = $this->users->get_user_by_username($this->session->userdata("username"))->id;
						$users = $this->db->from('users')->where("id",$id)->get();	
						}
						$num =1;
						foreach($users->result_array() as $user){
						$ins = $this->stock->getSalesRange($from,$to,array('payment_method'=>1,"user_id"=>$user['id']));
							$alltotal =0;
						$alldiscount =0;
						$allvat = 0;
						$allscharge = 0;
