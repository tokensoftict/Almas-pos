<div class="row">
	<div class="col-sm-12">
		...
		<div class="panel panel-default">
                ...
                <div class="panel-heading">Report By Payment Method and Sales Rep
                 <div class="tools">
					<form method="post" class="form-horizontal" id="change_branch" action="">
						...
						?>
							...
							<div class="col-md-3">
								...
								<?php
									$stockks = $this->db->from("users")->where("role !=","Superuser")->get()->result_array();
									foreach($stockks as $stockk){
								?>
									<option <?php echo ($stockk['id']==$_POST['customer_id2'] ? 'selected' : '') ?> value="<?php echo $stockk['id'] ?>"><?php echo $stockk['username'] ?></option>
								<?php
									}
								?>
								</select>
						...
						<div class="col-md-2">
							...
							<div class="col-md-3">
								...
								<?php
									...
									foreach($stockks as $stockk){
								?>
									<option  value="<?php echo $stockk['id'] ?>"><?php echo $stockk['username'] ?></option>
								<?php
									}
								?>
								</select>
				...
				<tbody>
					...
					$status = array(
						...
						$ins = $this->stock->getSalesRange($from,$to,array('payment_method'=>$customer_id,"user_id"=>$sales_re,"status"=>"COMPLETE"));
							$alltotal =0;
						$alldiscount =0;
						$allvat = 0;
						$allscharge = 0;
