					 ...
					 <div class="btn-group btn-sm">
												<div class="dropdown">
												  ...
												  <li><a href="<?php  echo base_url('dashboard/view_sales/'.$this->uri->segment(3)) ?>">View</a></li>
                                                      ...
                                                      <li><a onclick="window.open($(this).attr('href'),'width=400;hieght=400;','400','400'); return false;" href="<?php  echo base_url('dashboard/print_recipt/'.$in['reciept_id']) ?>/MediumWayBill">Medium Waybill</a></li>
                                                  </ul>
												</div>
								</div>
						<div class="btn-group btn-sm">
							...
							<?php
							if($user->role != "Sales Representative" && $user->role != "Service Administrator" && $user->role != "Manager"){
						...
						<div class="col-lg-12">
							...
							<div class="col-lg-12">
								<div class="alert alert-danger">
								  <strong>Voided Sales</strong> This sales has been voided by <b><?php  $u =  $this->db->get_where("users",array("id"=>$in['voided_by']))->row_array(); echo $u['firstname'] ?> <?php  echo $u['lastname']; ?></b> on <?php echo $in['date_voided'] ?><br/>
