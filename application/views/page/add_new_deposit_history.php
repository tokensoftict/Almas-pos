	...
	<div class="col-sm-12">
		...
		<div class="panel">
			 <div class="panel-heading"><a href="<?php echo base_url('dashboard/view_deposit/'.$this->uri->segment(3)) ?>" class="btn btn-sm btn-success">Back</a> New Deposits Payment
                 <div class="tools"><button type="submit" class="btn btn-sm btn-primary" id="sub"><i class="mdi mdi-save"></i> Save</button></div>
              </div>
			  <div class="panel-body">
				<div class="form-horizontal">
					...
					<input type="hidden" name="sales_rep" id="user_id"  value="<?php  echo $this->users->get_user_by_username($this->session->userdata("username"))->id ?>"/>
					<div class="form-group xs-mt-10">
