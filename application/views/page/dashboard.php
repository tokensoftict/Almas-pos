...
$total_out_of_stock =$this->db->get_where("stock",array("quantity"=>"0"))->num_rows();
...
<div class="row">
            ...
            <div class="col-xs-12 col-md-6 col-lg-3">
                        <div class="widget widget-tile">
                          ...
                          <div class="data-info">
                            <div class="desc" title="Monthly Received Report">Employee</div>
							<?php $emp = $this->db->from("users")->where("role !=","Superuser")->get()->result_array(); ?>
                            <div class="value"><span class="indicator indicator-positive mdi mdi-chevron-up"></span><span data-toggle="counter" data-end="<?php echo count($emp) ?>" class="number"><?php echo count($emp) ?></span>
                            </div>
                          </div>
                        </div>
            </div>
 ...
 <div class="col-xs-12 col-md-6 col-lg-3">
                        <div class="widget widget-tile">
						  ...
						  ?>
                            ...
                            <div class="value"><span class="indicator indicator-negative mdi mdi-chevron-down"></span><span data-toggle="counter" data-end="<?php echo $t_total_sales ?>" class="number"><?php echo $t_total_sales ?></span>
                            </div>
                          </div>
                        </div>
            </div>
 ...
 <div class="col-xs-12 col-md-6 col-lg-3">
     ...
     <div class="col-xs-12 col-md-6 col-lg-3">
                        <div class="widget widget-tile" onclick="location.href='<?php echo base_url('dashboard/stock_expiry')  ?>'">
						  ...
						  ?>
                            <div class="desc" title="Stock">No Expired Product</div>
			 ...
			 <div class="col-xs-12 col-md-6 col-lg-3">
                        <div class="widget widget-tile">
						  ...
						  ?>
                            ...
                            <div class="value"><span class="indicator indicator-equal mdi mdi-chevron-right"></span><span data-toggle="counter" data-end="<?php  echo $total_paid_invoice ; ?>" class="number"><?php  echo $total_paid_invoice; ?></span>
                            </div>
                          </div>
                        </div>
            </div>
