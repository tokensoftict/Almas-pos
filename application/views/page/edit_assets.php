			  ...
			  <div class="panel-body">
				<div class="form-horizontal">
					...
					<div class="form-group xs-mt-10">
                      ...
                      <div class="col-sm-8">
						<input id="date_sold" required type="text" value="<?php echo ($as['date_sold'] == "0000-00-00" ? "" : $as['date_sold']) ?>" name="date_sold" data-min-view="2" data-date-format="yyyy-mm-dd" placeholder="Date Sold" class="date form-control input-sm">
					 </div>
                    </div>
					<div class="form-group xs-mt-10">
					...
					<div class="form-group xs-mt-10">
                      ...
                      <div class="col-sm-8">
                        <input id="department" type="text"  name="department" value="<?php echo $as['department'] ?>" placeholder="Department" class="form-control input-sm">
                      </div>
                    </div>	
					<div class="form-group xs-mt-10">
