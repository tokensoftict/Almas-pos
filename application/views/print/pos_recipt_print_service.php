...
<head>
<link rel="stylesheet" href="<?php echo base_url('application/posfont/stylesheet1.css'); ?>"/>
...
#invoice-POS #legalcopy {
  ...
  <div id="invoice-POS" align="center">
     <div class="logo" style="margin-bottom:10px;"><center><img style="width:48mm;" src="<?php echo $logo; ?>" alt="" width="60" /></center></div>
    <br/><br/>
	  ...
	  <div class="info" align="center"> 
        <span style="font-weight:bolder;font-size:15px;margin-bottom:10px; display:block;">Payment Receipt.</span>
          <span style="font-weight:bolder;font-size:15px;margin-bottom:10px; display:block;"><?php echo $payment['department'] ?></span>
			...
			<span style="float:left;font-size:13px;;margin-bottom:6px;">Time   : <?php echo $payment['sales_time']; ?></span>   <span style="float:right;font-size:13px;;margin-bottom:6px;">Sales Rep  : <?php echo $this->users->get_user_by_id($payment['user_id'],1)->username; ?></span>
			...
			<span style="float:left;font-size:12px;">Payment Method: <?php echo $this->db->get_where("payment_method",array("SN"=>$payment['payment_method']))->row()->payment_method;  ?></span>
	...
	<!--End Invoice Mid-->
    <div id="bot">
	<h6 style="font-family:MyWebFont; font-size:12px;margin-top:-4px;"align="center">Service List(s)</h6>
		<div id="table" style="margin-top:-22px;">
						<table>
						<tr class="tabletitle">
								<td class="Rate"><h2 align="left">Service</h2></td>
								<td class="Rate"><h2 align="left">Price</h2></td>
								<td class="Rate"><h2 align="right">Total</h2></td>
							</tr>
							<?php
		...
		<div align="center" style="font-size:13px;"><?php
			...
			echo $settings['footer_rec_service'];
		?></div>		
	</div>
	</div>
  </div>
