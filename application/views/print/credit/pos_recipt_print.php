  ...
  <div id="invoice-POS" align="center">
    ...
    <br/>
	  ...
	  <div class="info" align="center"> 
        <span style="font-weight:bolder;font-size:15px;margin-bottom:10px; display:block;">Receipt.</span>

            <span style="float:left;font-size:13px;;margin-bottom:6px;">Credit ID  : <?php echo $payment['credit_id']  ?></span> <span style="float:right; font-size:13px;;margin-bottom:6px;">Date   : <?php echo $payment['date'];  ?></span>
           </br>
